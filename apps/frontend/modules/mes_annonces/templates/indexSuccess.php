...
<div id="listing">
	...
	<form method="GET" action="<?php echo url_for( $backref.'/index' ); ?>">
...
<?php else: ?>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td nowrap="nowrap" width="400px">
                        <a href="<?php echo url_for( 'detail/index?backref='.$backref.'&id='.$oAnnonce->getId() ) ?>"><?php echo $oAnnonce->getTitre(); ?></a><br/>
        ...
        <div style="clear: left;" id="resultcontainer">
            <div id="result_left">
                ...
                <span class="nohistory"><a href="<?php echo url_for( $backref.'/index' ); ?>?p=<?php echo $oPager->getPreviousPage(); ?>&t=<?php echo $sTitre; ?>&r=<?php echo $sRegion ?>">« Page précédente</a></span>
            	&nbsp;&nbsp;
                <?php endif; ?>
                ...
                <?php else: ?>
                <span class="nohistory"><a href="<?php echo url_for( $backref.'/index' ); ?>?p=<?php echo $oPage; ?>&t=<?php echo $sTitre; ?>&r=<?php echo $sRegion ?>"><?php echo $oPage; ?></a></span>
                <?php endif; ?>
            	<?php endforeach; ?>
                <?php if( $oPager->getPage() != $oPager->getNextPage() ): ?>
                &nbsp;&nbsp;
                <span class="nohistory"><a href="<?php echo url_for( $backref.'/index' ); ?>?p=<?php echo $oPager->getNextPage(); ?>&t=<?php echo $sTitre; ?>&r=<?php echo $sRegion ?>">Page suivante »</a></span>
            	<?php endif; ?>
            </div>
            <div id="result_right">
                <span class="nohistory"><a href="<?php echo url_for( $backref.'/index' ); ?>?p=<?php echo $oPager->getLastPage(); ?>&t=<?php echo $sTitre; ?>&r=<?php echo $sRegion ?>">Dernière page</a></span>
            </div>
        </div>
<?php endif; ?>
</div>