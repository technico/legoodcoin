...
class BaseAnnonceFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'categorie'          => new sfWidgetFormDoctrineChoice(array('model' => 'Categorie', 'add_empty' => true), array(), 'Toute les catégories'),
      'region'             => new sfWidgetFormDoctrineChoice(array('model' => 'Region', 'add_empty' => true), array(), 'Toute la France'),
      'departement'        => new sfWidgetFormDoctrineChoice(array('model' => 'Departement', 'add_empty' => true), array(), 'Tous les départements'),
