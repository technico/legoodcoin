...
<option value="8" class="titre_option">-- IMMOBILIER --</option>
...
<option value="14" class="titre_option">-- MULTIMEDIA --</option>
...
<option value="18" class="titre_option">-- MAISON --</option>
...
<option value="21">Bricolage / Jardinage</option>
<option value="22">VÃªtements</option>
<option value="47">Accessoires &amp; Bagagerie</option>
<option value="42">Montres &amp; Bijoux</option>
<option value="23">Equipement bébé</option>
<option value="24" class="titre_option">-- LOISIRS --</option>
...
<option value="31" class="titre_option">-- EMPLOI &amp; SERVICES --</option>
<option value="32">Matériel professionnel</option>
