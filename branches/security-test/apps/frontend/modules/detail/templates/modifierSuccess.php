...
<form method="post" action="<?php echo url_for( 'detail/modifier?id='.$id ) ?>">
<h2 style="font-weight:bold; font-size: 14px;">Modifer votre annonce</h2>
<div>Mot de passe <input type="password" name="mdp" /> <input type="submit" value="Modifier"/></div>
